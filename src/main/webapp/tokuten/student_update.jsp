	...
	<div class="updata-form">
		<form method="post" action="/test/main/StudentUpdateServlet"
			...
			<input type="hidden" name="no"
				...
				type="hidden" name="entYear"
				value="<%= request.getParameter("entYear") %>"> <label
				for="no">学籍番号:</label> <span id="noLabel"></span><br> <label
				for="entYear">入学年度:</label> <span id="entYearLabel"></span><br>
			<label for="name">氏名:</label> <input type="text" id="name"
				name="name"> <label for="classNum">クラス番号:</label> <input
				type="text" id="classNum" name="classNum"> <label
				for="isAttend">在学中</label> <input type="checkbox" id="isAttend"
				name="isAttend" value="TRUE"> <input type="hidden"
				name="isAttend" value="FALSE"> <input type="submit"
				value="変更">
		</form>
	</div>
